...
part of 'live_offers_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveOffersState);
}
...
/// @nodoc
class $LiveOffersStateCopyWith<$Res>  {
$LiveOffersStateCopyWith(LiveOffersState _, $Res Function(LiveOffersState) __);
}


/// Adds pattern-matching-related methods to [LiveOffersState].
extension LiveOffersStatePatterns on LiveOffersState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initial value)?  initial,TResult Function( _Loading value)?  loading,TResult Function( _Success value)?  success,TResult Function( _Error value)?  error,TResult Function( _LoadingMore value)?  loadingMore,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial value)  initial,required TResult Function( _Loading value)  loading,required TResult Function( _Success value)  success,required TResult Function( _Error value)  error,required TResult Function( _LoadingMore value)  loadingMore,}){
final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initial value)?  initial,TResult? Function( _Loading value)?  loading,TResult? Function( _Success value)?  success,TResult? Function( _Error value)?  error,TResult? Function( _LoadingMore value)?  loadingMore,}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case _Loading() when loading != null:
...
class _Initial implements LiveOffersState {
  const _Initial();
...
@override
String toString() {
  return 'LiveOffersState.initial()';
}
...
class _Loading implements LiveOffersState {
  const _Loading();
...
@override
String toString() {
  return 'LiveOffersState.loading()';
}
...
class _Success implements LiveOffersState {
  const _Success(this.data);
  

 final  LiveOffersEntity data;
...
@override
String toString() {
  return 'LiveOffersState.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $LiveOffersStateCopyWith<$Res> {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $LiveOffersStateCopyWith<$Res> {
...
class _LoadingMore implements LiveOffersState {
  const _LoadingMore(this.currentData);
  

 final  LiveOffersEntity currentData;
...
@override
String toString() {
  return 'LiveOffersState.loadingMore(currentData: $currentData)';
}
...
/// @nodoc
abstract mixin class _$LoadingMoreCopyWith<$Res> implements $LiveOffersStateCopyWith<$Res> {
  factory _$LoadingMoreCopyWith(_LoadingMore value, $Res Function(_LoadingMore) _then) = __$LoadingMoreCopyWithImpl;
@useResult
$Res call({
 LiveOffersEntity currentData
});
